namespace BRAssetBundler
{
    namespace Platform
    {
        void ParseConsoleOutputFromListFilesInArchive(const AZStd::string& consoleOutput, AZStd::vector<AZStd::string>& fileEntries, AZStd::vector<AZ::u32>& fileOffsets,
            AZStd::vector<AZ::u32>& fileSizes)
        {
